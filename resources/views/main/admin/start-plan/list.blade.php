    ...
    <main class="content px-3 py-4">
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('start#planAdd') }}">
                    <button type="button" class="btn btn-primary mt-2 me-3">Add Starter Plan</button>
                </a>
            </div>
            ...
            <div id="table-bg">
                <div class="my-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                <a href="{{ route('start#planView',$p->project_permission) }}" class="text-decoration-none me-2" id="edit">
                                                    <button class="item btn bg-warning text-dark" data-toggle="tooltip"
                                                        data-placement="top" title="View">
                                                        View More
                                                    </button>
                                                </a>
                                                <a href="{{ route('start#planPerDelete',$p->project_permission) }}" class="text-decoration-none" id="delete"
                    ...
                    @else
                        <h6 class=" text-center text-secondary mt-4">There is no starter plan here yet!</h6>
                    @endif
                    {{-- <div>
                        {{ $projectPlans->links() }}
                    </div> --}}
