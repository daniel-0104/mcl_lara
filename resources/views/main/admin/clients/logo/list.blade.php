        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between">
                <div class="bg-white text-dark px-3 border rounded pt-2 h-100 text-center">
                    <h5>Total - {{ count($clientLogos) }}</h5>
                </div>
                <button type="button" class="btn btn-primary mt-2 me-3" data-bs-toggle="modal" data-bs-target="#add-logo">Add Logo Image</button>
            </div>
            ...
            <div id="table-bg">
                <div class="my-3">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $counter++ }}</td>
                                        <td>
                                            <img src="{{ asset('storage/client-logo/'.$c->image) }}" class="w-50 d-block" alt="">
                                        </td>
                                        <td>
                                            <div class="table-data-feature">
                                                <a href="{{ route('logo#edit',$c->id) }}" class="text-decoration-none" id="edit">
                                                    <button class="item btn bg-primary text-white" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="fa-solid fa-pen"></i>
                                                    </button>
                                                </a>
                                                <a href="{{ route('logo#delete',$c->id) }}" class="text-decoration-none" id="delete">
                    ...
                    @else
                        <h6 class=" text-center text-secondary mt-4">There is no client logo here yet!</h6>
                    @endif
                    <div>
                        {{ $clientLogos->links() }}
                    </div>
                ...
                <!--add category modal -->
                <div class="modal fade" id="add-logo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="add-logoLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title d-block w-100 text-center" id="add-logoLabel">Add Website Logo</h3>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form action="{{ route('logo#create') }}" method="post" class="mt-1" enctype="multipart/form-data">
                                    @csrf
